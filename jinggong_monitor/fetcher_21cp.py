...
TARGETS = [
    ...
    # 2026-09-10 新增（需求表「无标题表格(11).xlsx」）：独山子石化 K8003
    # 注：K8003 同名牌号众多（宁夏宝丰/山东裕龙/台化/东方能源/恒力/荣盛/中韩武汉/扬子/上海赛科），
    #     必须用 "dushanzi"/"独山子" 精确过滤，否则会误抓别家。
    ("PP_K8003",   "K8003",  ["dushanzi", "独山子"], [], "独山子石化PP K8003"),
